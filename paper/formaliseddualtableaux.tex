...
here:\marginpar{JED, a more permanent archive?}
...
signed formula), while \texttt{rule} (an ordinary rule) models
an\marginpar{What is an ``ordinary'' rule ? As opposed to what ?}
...
\marginpar{JED?}\textbf{How much theory had to be developed that is not specific to this
